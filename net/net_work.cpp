...
namespace mynamespace {
    ...
    int NetWork::pull_msg(unsigned char *undo_msg, int *undo_msg_length, unsigned char *&done_msg, int *&done_msg_length) {
        ...
        //std::cout << "iNetWork :: ull_msg_this" << undo_task_msg << std::endl;
        //std::cout << "iNetWork :: pull_msg" << undo_task_msg->send_msg_length << std::endl;
        *undo_msg_length = undo_task_msg->recv_msg_length;
        memcpy(undo_msg, undo_task_msg->recv_msg, *undo_msg_length);
        //std::cout << "NetWork recv_buf:" << undo_msg << endl;
        done_msg = undo_task_msg->send_msg;
        done_msg_length = (int *)undo_task_msg->send_msg_length;
        //std::cout << "NetWork:" << undo_task_msg->send_msg_length << std::endl;

        //cout << "&m_task_pool" << m_task_pool << endl;
        //cout << "undo_task" << undo_task << endl;

        //std::cout << "NetWork TaskId:" << undo_task_msg->task_id << endl;
